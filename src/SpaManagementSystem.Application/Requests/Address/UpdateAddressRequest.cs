namespace SpaManagementSystem.Application.Requests.Address
{
    ...
    public class UpdateAddressRequest
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAddressRequest"/> class with the specified address details.
        /// </summary>
        ...
        public UpdateAddressRequest(string country, string region, string city, string postalCode, string street,
